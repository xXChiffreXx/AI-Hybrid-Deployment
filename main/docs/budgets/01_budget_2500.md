...
- `ollama-server` for initial extraction and timed batched local fill attempts
...
This is the reference tier selected for the Summer 2026 pilot plan in [`../planning/00_summer_project_brief.md`](../planning/00_summer_project_brief.md).
